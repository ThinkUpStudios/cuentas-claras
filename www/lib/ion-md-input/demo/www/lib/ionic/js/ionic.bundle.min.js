...
!function () {
  ...
  window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.1.0-nightly-1583", function (e) {
...
!function () {
  function e(e, t, n, i, o, r) {
    function a(i, a, c, s, l) {
      ...
      function $() {
        O || l(H = i.$new(), function (e) {
          e[0].removeAttribute("collection-repeat"), O = e[0]
        }), H[B] = (x(i) || [])[0], o.$$phase || H.$digest(), y.appendChild(O);
  ...
  function t(e, t, n) {
    ...
    return function (o) {
      ...
      this.refreshLayout = function () {
        ...
        if ($.style[ionic.CSS.TRANSFORM] = O.replace(N, -l).replace(z, 0), q -= l, I.__clientHeight && I.__clientWidth || (I.__clientWidth = I.__container.clientWidth, I.__clientHeight = I.__container.clientHeight), (ee.onRefreshLayout || angular.noop)(), ee.refreshDirection(), Q(), !ie)for (var u = Math.max(20, 3 * T), d = 0; u > d; d++)G.push(new s);
  ...
  var c = angular.module("ionic", ["ngAnimate", "ngSanitize", "ui.router", "ngIOS9UIWebViewPatch"]), s = angular.extend, l = angular.forEach, u = angular.isDefined, d = angular.isNumber, f = angular.isString, h = angular.element, p = angular.noop;
  c.factory("$ionicActionSheet", ["$rootScope", "$compile", "$animate", "$timeout", "$ionicTemplateLoader", "$ionicPlatform", "$ionicBody", "IONIC_BACK_PRIORITY", function (e, t, n, i, o, r, a, c) {
    ...
    return M.prototype.initialize = function (e) {
      ...
      register: function (e, t) {
        var i, a, s, u = g(), d = h(e), $ = L.currentView, M = L.backView, N = L.forwardView, z = null, O = null, H = _, q = d.historyId, U = n.url();
        if (b !== u && (b = u, R++), C)z = C.viewId, O = C.action, H = C.direction, C = null; else if (M && M.stateId === u)z = M.viewId, q = M.historyId, O = I, M.historyId === $.historyId ? H = A : $ && (H = P, i = f(M.historyId), i && i.parentHistoryId === $.historyId ? H = V : (i = f($.historyId), i && i.parentHistoryId === d.parentHistoryId && (H = D))); else if (N && N.stateId === u)z = N.viewId, q = N.historyId, O = x, N.historyId === $.historyId ? H = E : $ && (H = P, $.historyId === d.parentHistoryId ? H = V : (i = f($.historyId), i && i.parentHistoryId === d.parentHistoryId && (H = D))), i = p(e), N.historyId && i.scope && (i.scope.$historyId = N.historyId, q = N.historyId); else if ($ && $.historyId !== q && d.cursor > -1 && d.stack.length > 0 && d.cursor < d.stack.length && d.stack[d.cursor].stateId === u) {
          var W = d.stack[d.cursor];
          z = W.viewId, q = W.historyId, O = I, H = D, i = f($.historyId), i && i.parentHistoryId === q ? H = P : (i = f(q), i && i.parentHistoryId === $.historyId && (H = V)), i = c(W.backViewId), i && W.historyId !== i.historyId && (d.stack[d.cursor].backViewId = $.viewId)
        } else {
          ...
          2 > R && (H = _), L.views[z] = this.createView({
            viewId: z,
        ...
        if (v(z), L.backView && q == L.backView.historyId && u == L.backView.stateId && U == L.backView.url)for (a = 0; a < d.stack.length; a++)if (d.stack[a].viewId == z) {
          O = "dupNav", H = _, a > 0 && (d.stack[a - 1].forwardViewId = null), L.forwardView = null, L.currentView.index = L.backView.index, L.currentView.backViewId = L.backView.backViewId, L.backView = l(L.backView), d.stack.splice(a, 1);
          break
        }
  ...
  c.factory("$ionicPopup", ["$ionicTemplateLoader", "$ionicBackdrop", "$q", "$timeout", "$rootScope", "$ionicBody", "$compile", "$ionicPlatform", "$ionicModal", "IONIC_BACK_PRIORITY", function (e, t, n, i, o, r, a, c, l, u) {
    ...
    var E, V = ionic.DomUtil.cachedAttr, P = [], D = 1100, _ = {
      create: function (t, l, h, T, E, R) {
        var L, M, N, z = ++A, O = {
          init: function (e, t) {
            _.isTransitioning(!0), O.loadViewElements(e), O.render(e, function () {
              t && t()
            })
            ...
            function b() {
              b.x || (b.x = !0, L.off($, w), e.cancel(L.data(k)), M && e.cancel(M.data(k)), O.emit("after", H, q), C && C.resolve(t), z === A && (n.all(P).then(_.transitionEnd), O.cleanup(H)), r._instances.forEach(function (e) {
            ...
            var U = o.transitions.views[H.transition] || o.transitions.views.none, W = U(L, M, H.direction, H.shouldAnimate && u && R);
            if (W.shouldAnimate && (L.on($, w), L.data(k, e(b, D)), i.show(D)), E && (O.emit("before", H, q), p(L, x), W.run(0)), R && (C = n.defer(), P.push(C.promise)), E && R)e(v, 16); else {
